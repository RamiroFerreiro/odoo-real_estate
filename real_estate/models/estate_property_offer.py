...
class EstatePropertyOffer(models.Model):
    ...
    def create(self, vals_list):
        for vals in vals_list:
            ...
            best_offer = property_id.best_offer
            ...
            if(property_id.state == "new" or  property_id.state == "offer_received"):
                ...
                if( vals["price"] >= best_offer):
                    ...
                    raise UserError("Error: No se puede ofertar a un precio menor que la mejor oferta")
                
            else:
                raise UserError("Error: Solo se puede ofertar a un estado NUEVO o OFERTA RECIBIDA")
